...
if __name__ == '__main__':
    ...
    processors['pretrain_skeletonclr_swap'] = import_class(
        'processor.pretrain_skeletonclr_swap.SkeletonCLR_Processor')
    processors['pretrain_skeletonclr_multi_swap'] = import_class(
        'processor.pretrain_skeletonclr_multi_swap.SkeletonCLR_Processor')
    processors['pretrain_skeletonclr_multi_swapv2'] = import_class(
        'processor.pretrain_skeletonclr_multi_swapv2.SkeletonCLR_Processor')
    processors['pretrain_skeletonclr_cont'] = import_class(
        'processor.pretrain_skeletonclr_cont.SkeletonCLR_Processor')
